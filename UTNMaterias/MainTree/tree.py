class Subject():
    def __init__(self, sql_id, name, is_approved, is_regular, is_enrollable) -> None:
        self.sql_id = sql_id
        self.name = name
    ...
    def newChild(self, subject, subject_conection) -> None:
...
class Tree():
    ...
    def add(self, father_sql_id: int, child_subject: Subject, subject_conection: str):
